...
"""
For DE only: is_adaptive = False, is_jops = False,
For BRBaDE: is_adaptive = True, is_jops = False,
For JOPS: is_adaptive = True, is_jops = True,
"""
is_adaptive = True
is_jops = True
...
def getTestRMSE(best_param):
    predicted_aqi = []
    brb = BRBJOPS(best_param, model_type, num_ref_value=numRefVal, isDebug = False)
